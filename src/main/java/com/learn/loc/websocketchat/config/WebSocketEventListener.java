package com.learn.loc.websocketchat.config;
...
import com.learn.loc.websocketchat.models.Message;
	...
	public void handleWebSocketDisconnectListener(SessionDisconnectEvent event) {
		...
		if (Objects.nonNull(username)) {
			...
			messagOperations.convertAndSend("/topic/chat",
					Message.builder().type(MessageType.LEAVE).sender(username).build());
		}
	}
